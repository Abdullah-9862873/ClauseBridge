...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_audit_log_firm_id"), "audit_log", ["firm_id"], unique=False
    )
    op.create_index(
        "ix_audit_log_firm_id_created_at",
        "audit_log",
        ["firm_id", "created_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_clauses_document_id"), "clauses", ["document_id"], unique=False
    )
    op.create_table(
        "anomalies",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_anomalies_clause_id"), "anomalies", ["clause_id"], unique=False
    )
